...
public class TestResponseUtil {
    ...
    // public static void validateTestResponse(PageDetailsResponse
    // pageDetailsResponse, PaymentRequestBean requestData,
    // ITheiaSessionDataService sessionDataService, TestResource testResource,
    // String testResponseKey) {
    //
    // String expectedTestResponse =
    // testResource.getTestProperties().getProperty(testResponseKey);
    // @SuppressWarnings("unchecked")
    // Map<String, String> responseConstraints =
    // TestRequestUtil.mapJsonToObject(testResource.getObjectMapper(),
    ...
    // ETestResponseValidation validation =
    // ETestResponseValidation.getResponseValidationByName(entry.getKey());
    // if (validation != null) {
    // validateConstraint(validation, pageDetailsResponse, requestData,
    // sessionDataService, entry.getValue());
    // }
    // }
    // }

    // private static void validateConstraint(ETestResponseValidation
    // validation, PageDetailsResponse pageDetailsResponse,
    // PaymentRequestBean requestData, ITheiaSessionDataService
    // sessionDataService, String value) {
    ...
    // LoginInfo loginInfo =
    // sessionDataService.getLoginInfoFromSession(requestData.getRequest(),
    // false);
    ...
    // CardInfo cardInfo =
    // sessionDataService.getCardInfoFromSession(requestData.getRequest(),
    // false);
    // if (testFlag) {
    ...
    // if (testFlag) {
    // String redirectPage = (String)
    // requestData.getRequest().getSession(false).getAttribute("bankHTML");
    // assertTrue(StringUtils.isNotBlank(redirectPage),
    // "Redirect Page found null in session");
    // }
    // break;
    // case DIGITAL_CREDIT_ENABLED:
    // DigitalCreditInfo digitalCreditInfo =
    // sessionDataService.getDigitalCreditInfoFromSession(
    // requestData.getRequest(), false);
    // if (testFlag) {
    // assertTrue(digitalCreditInfo.isDigitalCreditEnabled(),
    // "DigitalCreditInfo not enabled!");
    ...
    // sessionDataService.getTxnInfoFromSession(requestData.getRequest(),
    // false);
    // if (testFlag) {
