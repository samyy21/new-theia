...
//
//public class FetchDeepLinkRequestHeader {
//
...
//        final StringBuilder sb = new StringBuilder("FetchDeepLinkRequestHeader{");
//        sb.append("clientId='").append(clientId).append('\'');
//        sb.append(", requestTimestamp='").append(requestTimestamp).append('\'');
//        sb.append(", version='").append(version).append('\'');
//        sb.append(", requestMsgId='").append(requestMsgId).append('\'');
