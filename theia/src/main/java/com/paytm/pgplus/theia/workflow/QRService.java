...
//
//    @Autowired
//    @Qualifier(value = "dynamicQrPaymentService")
//    private IPaymentService dynamicQrPaymentService;
//
//    @Autowired
...
//
//    public PageDetailsResponse processDynamicQRRequest(final PaymentRequestBean paymentRequestData, final Model model) {
...
//        String htmlPage;
//
//        validationResult = dynamicQrPaymentService.validatePaymentRequest(paymentRequestData);
//
...
//
//            processed = dynamicQrPaymentService.processPaymentRequest(paymentRequestData, model);
